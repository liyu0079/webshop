    ...
    <div id="container">
      <el-row>
        ...
        <el-col :span="4"
          ...
          <el-menu
            ...
            <el-menu-item
              ...
              <i
                :class="cate.cate_icon"></i>
              <span
                slot="title">{{cate.cate_name}}</span>
            </el-menu-item>
          </el-menu>
        </el-col>
        <!-- 轮播图 -->
        ...
        <el-col :span="4"
          ...
          <button
            class="welfare">新人福利</button>
          <button
            class="vip">加入会员</button>
        </el-col>
      </el-row>
      <!-- 分类产品展示区域 -->
      <div class="product"
        ...
        <div class="pro_line">
          ...
          <div><a
              @click.prevent="getRList(cate.cate_id)">MORE</a>
          </div>
        </div>
        <div class="pro_show">
          <ProductItem

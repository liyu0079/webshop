  ...
  data() {
    return {
      ...
      rules: {
        ...
        goods_name: [{ required: true, message: '请填写商品详情', trigger: 'blur' }],
        price: [{ required: true, message: '请输入商品特价', trigger: 'blur' }],
        counts: [{ required: true, message: '请输入商品库存', trigger: 'blur' }],
        category: [{ required: true, message: '请选择商品分类号', trigger: 'blur' }],
        sales_tip: [{ required: true, message: '请输入商品标签', trigger: 'blur' }],
      },
      options: [
        {
          value: 1,

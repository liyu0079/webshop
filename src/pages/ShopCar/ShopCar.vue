    ...
    <div id="footer">
      <div
        ...
        <input type="checkbox"
          ...
          @click.stop="selectedAll(isSelectedAll)" />
        <label
          for="foot_selectAll">全选</label>
      </div>
      <div class="foot_op">
        <a class="foot_remove"
          @click.prevent="emptyCart">清空购物车</a>
      </div>
      <div class="foot_total">
        <div
          ...
          <span
            class="txt">已选商品</span>
          <strong
            id="selected_amout">{{orderInfo.buy_count}}</strong>
          <span
            class="txt">件</span>
        </div>
        <div

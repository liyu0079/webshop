        ...
        <nav
          ...
          <div
            ...
            <el-menu
              ...
              <el-menu-item
                index="1"
                @click="goTo('/selfcenter/profile')">
                <i
                  class="el-icon-document-copy"></i>
                <span
                  slot="title">我的资料</span>
              </el-menu-item>
              <el-submenu
                index="2">
                <template
                ...
                <el-menu-item-group>
                  <el-menu-item
                    index="2-1"
                    @click="goTo('/selfcenter/update')">
                    修改基本信息
                  </el-menu-item>
                  <el-menu-item
                    index="2-2"
                    @click="goTo('/selfcenter/editphone')">
                    修改手机号
                  </el-menu-item>
                  <el-menu-item
                    index="2-3"
                    @click="goTo('/selfcenter/editpwd')">
                    修改密码
                  </el-menu-item>
                </el-menu-item-group>
              </el-submenu>

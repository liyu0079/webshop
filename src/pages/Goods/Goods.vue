  ...
  <div id="container"
    ...
    <div class="pro_detail">
      <div class="pro_img">
        <div class="tb_booth">
          <img
            :src="goodsDetail[0].image_url"
            class="pro_middle_img" />
        </div>
      </div>
      <div class="pro_meg">
        <div
    ...
    <div class="pro_comment">
      <h3>商品评价</h3>
      <div
        v-if="goodsDetail[0].comments_count">
        <div class="media"
    ...
    <div class="pro_judge"
      ...
      <h3>评价该商品</h3>
      <span
        class="judge_erro_tip">登录后才可发表评论</span>
    </div>
  </div>
</template>
